...
const Modules = () => {
  ...
  const categories = [
    { name: 'All', icon: BookOpen, count: 18 },
    { name: 'Web Security', icon: Globe, count: 6 },
    { name: 'Network Security', icon: Wifi, count: 4 },
    { name: 'Cryptography', icon: Lock, count: 3 },
    { name: 'Ethical Hacking', icon: Shield, count: 3 },
    { name: 'Secure Coding', icon: Code, count: 2 }
  ];
  ...
  const modules = [
    ...
    },
    {
      ...
      description: "Deep dive into SQL injection vulnerabilities, exploitation techniques, and prevention strategies.",
      category: "Web Security",
      level: "Intermediate",
      duration: "3 hours",
      lessons: 12,
    ...
    },
    {
      ...
      description: "Understanding XSS attacks, payload crafting, and implementing effective defense mechanisms.",
      category: "Web Security",
      level: "Intermediate",
      duration: "2.5 hours",
      lessons: 10,
    ...
    },
    {
      ...
      description: "Learn to analyze network protocols, identify vulnerabilities, and understand traffic patterns.",
    ...
    {
      id: 5,
      title: "Symmetric Cryptography Fundamentals",
      description: "Explore symmetric encryption algorithms, key management, and practical implementations.",
    ...
    },
    {
      ...
      description: "Systematic approach to penetration testing, from reconnaissance to reporting.",
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Structured learning paths to master cybersecurity concepts step by step
        </p>
      </div>
          ...
          {filteredModules.map((module) => (
            <Card key={module.id} className="overflow-hidden hover:shadow-lg transition-all duration-300 border-border/50 hover:border-primary/30">
              <div className="aspect-video relative bg-gradient-to-br from-secondary/50 to-accent/20">
                ...
                />
                <Badge 
                  variant={module.level === 'Beginner' ? 'secondary' : module.level === 'Advanced' ? 'destructive' : 'default'}
